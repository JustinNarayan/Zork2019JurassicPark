...
public class RoomItemInit {
	...
	private static void initEnvironmentItems() {
		...
		roomsWithLeafPiles.add("DILOPHOSAURUS_NE");
	...
	private static void initArtifacts() {
		...
		artifacts.add(new Artifacts("Personnel records for the T-Rex enclosure", "These are personnel records for the T-Rex enclosure.", 13, getMap().get("TREX_CONTROL"), getMap().get("TREX_CONTROL").getRoomInventory().getEnvironmentItem("a desk")));
		artifacts.add(new Artifacts("Personnel records for the Stegosaurus enclosure", "These are personnel records for the Stegosaurus enclosure.", 13, getMap().get("STEGOSAURUS_CONTROL"), getMap().get("STEGOSAURUS_CONTROL").getRoomInventory().getEnvironmentItem("a desk")));
		artifacts.add(new Artifacts("Personnel records for the Velociraptor enclosure", "These are personnel records for the Velociraptor enclosure.", 13, getMap().get("VELOCIRAPTOR_CONTROL"), getMap().get("VELOCIRAPTOR_CONTROL").getRoomInventory().getEnvironmentItem("a desk")));
		artifacts.add(new Artifacts("Personnel records for the Pterodactyl enclosure", "These are personnel records for the Pterodactyl enclosure.", 13, getMap().get("PTERODACTYL_CONTROL"), getMap().get("PTERODACTYL_CONTROL").getRoomInventory().getEnvironmentItem("a desk")));
		artifacts.add(new Artifacts("Personnel records for the Triceratops enclosure", "These are personnel records for the Triceratops enclosure.", 13, getMap().get("TRICERATOPS_CONTROL"), getMap().get("TRICERATOPS_CONTROL").getRoomInventory().getEnvironmentItem("a desk")));
		artifacts.add(new Artifacts("Personnel records for the Dilophosaurus enclosure", "These are the personnel records from the Dilophosaurus enclosure.",13, getMap().get("DILOPHOSAURUS_CONTROL"), getMap().get("DILOPHOSAURUS_CONTROL").getRoomInventory().getEnvironmentItem("a desk")));
		artifacts.add(new Artifacts("Personnel records for the Bronchiosaurus enclosure", "These are personnel records for the Bronchiosaurus enclosure", 13, getMap().get("BRONCHIOSAURUS_CONTROL"), getMap().get("BRONCHIOSAURUS_CONTROL").getRoomInventory().getEnvironmentItem("a desk")));
		artifacts.add(new Artifacts("Personnel records for the Spinosaurus enclosure", "These are personnel records for the Spinosaurus enclosure.", 13, getMap().get("SPINOSAURUS_CONTROL"), getMap().get("SPINOSAURUS_CONTROL").getRoomInventory().getEnvironmentItem("a desk")));
		...
		artifacts.add(new Artifacts("Personnel records for the entire island", "These are personnel records for the entire island.", 10, getMap().get("RECORDS_W"), getMap().get("RECORDS_W").getRoomInventory().getEnvironmentItem("a desk")));
